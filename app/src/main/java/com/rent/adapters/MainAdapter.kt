...
class MainAdapter(var list: MutableList<String>)  : RecyclerView.Adapter<MainAdapter.MainViewHolder>() {
    private var removedPosition: Int = 0
    private var removedItem: String? = null
    ...
    override fun onBindViewHolder(viewHolder: MainViewHolder, position: Int) {
        viewHolder.amount.text = list[position]
    }
