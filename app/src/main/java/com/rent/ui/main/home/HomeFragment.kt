...
import com.rent.global.utils.inflate
...
//    val onClick: (Flight) -> Unit,
    private val mContext: Context, private val manager: FragmentActivity?
) : RecyclerView.Adapter<HomeItemsAdapter.HomeItemsViewHolder>() {

    val flights = mutableListOf<Flight>()
    var locations: ArrayList<Rental> = ArrayList()
...
//            val res: Rental? = locations[position]
...
//        }
        fun bind(loc: Flight) {
            ...
            containerView.findViewById<TextView>(R.id.itemDepartureAirportCodeText).text =
                loc.departure.code
            containerView.findViewById<TextView>(R.id.itemDepartureAirportCityText).text =
                loc.departure.city
            ...
            locationService.selectLocations()
                ...
                .subscribe(
                    { result ->
                        ...
                        println(locations)
                        flights = generateFlights(locations!!)
